            ...
            <Table className={classes.table} aria-label="customized table">
                <TableHead>
                    <TableRow>
                        ...
                        {columns.transaction_id && <StyledTableCell align="center"><Typography variant="body1_bold" text="Transaction ID" /></StyledTableCell>}
                        {columns.order_id && <StyledTableCell align="center"><Typography variant="body1_bold" text="Order ID" /></StyledTableCell>}
                        {columns.customer && <StyledTableCell align="center"><Typography variant="body1_bold" text="Customer" /></StyledTableCell>}
                        {columns.payment_status && <StyledTableCell align="center"><Typography variant="body1_bold" text="Payment Status" /></StyledTableCell>}
                        {columns.gross && <StyledTableCell align="center"><Typography variant="body1_bold" text="Gross" /></StyledTableCell>}
                        {columns.actions && <StyledTableCell align="center"><Typography variant="body1_bold" text="Actions" /></StyledTableCell>}
                    </TableRow>
                </TableHead>
                <TableBody>
                    {transactions.map((row) => (
                        <StyledTableRow key={row.name}>
                            ...
                            {columns.gross && <StyledTableCell align="center"><Typography variant="body2" text={`${currencyCodeMapper[row.amount.currency]}${row.amount.subtotal}`} /></StyledTableCell>}
