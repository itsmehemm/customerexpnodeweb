...
export default class PaymentActivity extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    async componentDidMount() {
        ...
        document.title = `Payment: ${transactionId} - Tinnat Business`;
        const response = await getPaymentActivityInternal(transactionId);
